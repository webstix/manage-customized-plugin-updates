jQuery(document).ready(function() {
    ...
    jQuery('#the-list tr').each(function() {
        if(jQuery(this).hasClass('wsx_plugin_note')) {  
            jQuery(".wsx_plugin_note").prev().find('th').css("box-shadow", "none"); 
            jQuery(".wsx_plugin_note").prev().find('td').css("box-shadow", "none");
        } else {
            jQuery('.wsx_plugin_note').css("box-shadow", "0 -1px 0 rgba(0, 0, 0, 0.1) inset");         
        }
    });
